...
const int FAKE_INFINITY = 1000000000;
...
int main(void)
{
    ...
    while (1)
    {
        ...
        // Now that we have a new pair to add, check if this makes a full
        // circuit. If it does, the total is the x dims of the pair

        // Now we need to find the largest connected graph
        ...
        while (1)
        {
            ...
            for (int i = 0; i < total_stored_pairs; i++)
            {
